...
jQuery(function() {
	...
	if (cc == 'grid') {	
		...
		jQuery("#event_map").removeClass("active");
		jQuery('#evet_listing_map').css('visibility','hidden');
		jQuery('#evet_listing_map').height('0');
	}else if(cc == 'event_map'){		
		jQuery('#loop_event_taxonomy').hide();
		jQuery('#loop_event_archive').hide();
		jQuery("#listview").removeClass("active");
		jQuery('#evet_listing_map').css('visibility','visible');
		jQuery('#evet_listing_map').height('auto');
		jQuery("#event_map").addClass("active");		
...
jQuery(document).ready(function() {
	...
	jQuery('.viewsbox a#event_map').click(function(e){	
		e.preventDefault();
		...
		jQuery.cookie("display_view", "event_map");
	});
});
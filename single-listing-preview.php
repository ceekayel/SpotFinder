...
if(isset($_REQUEST['pid']) && $_REQUEST['pid']!='' && $_REQUEST['page'] != 'preview'){
	...
	<?php if($address!=''):?>
          ...
          <div id="listing_map">
               <div id="directory_location_map" style="width:100%;">
                    ...
                    <?php if(file_exists(TEMPL_MONETIZE_FOLDER_PATH.'templatic-custom_fields/google_map_detail.php')){
    ...
    <div class="breadcrumb breadcrumbs"></div>
		...
		<div id="post-<?php the_ID(); ?>" class="listing type-listing listing-type-preview hentry" >  
                                        ...
                                        <div class="entry-header-title">
                                        	...
                                        	<?php if($address!=""):?>
                                                  <div class="entry_address">
                                                  	<p><i class="sf-icon"></i><?php echo $address?></p>
                                                  </div>
                                                  <?php endif;?>
                                        </div>                    
	          ...
	          <?php do_action('directory_preview_before_post_content'); /*Add Action for after preview post content. */?>
               	...
               	<div id="tabs">
                    	 <ul>
                              <li><a href="#listing_description"><?php _e('Overview',TDOMAIN);?></a></li>
                             
                              <?php if($special_offer!=""):?>
                              <li><a href="#special_offer"><?php _e('Special Offer',TDOMAIN);?></a></li>
                              <?php endif;?>
                              
                              <?php if($video!=""):?>
                              <li><a href="#listing_video"><?php _e('Video',TDOMAIN);?></a></li>
                              <?php endif;?>

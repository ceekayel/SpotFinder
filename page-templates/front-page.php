...
if(is_active_sidebar('below_theme_header')){ ?>
<section class="section-row">
	<?php dynamic_sidebar('below_theme_header'); ?>
</section>
<?php } 
if(is_active_sidebar('above_homepage_content')){
?>
<section class="section-row white-bg">
	<?php dynamic_sidebar('above_homepage_content'); ?>
</section>
<?php } ?>

<div class="front_coontent_wrapper">
<section id="content">
  <?php do_action( 'open_front_content' ); // supreme_open_content 
    ...
    <div class="hfeed">
		<?php 
			...
			dynamic_sidebar( 'before-content' ); // Loads the sidebar-before-content.php template. ?>

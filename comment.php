  ...
  <div id="comment-<?php comment_ID(); ?>" class="comment-wrap">
    ...
    <div class="comment-content comment">
      ...
      if ( '0' == $comment->comment_approved && 1==apply_filters('comment_approved_filter',1)) : 
		echo apply_atomic_shortcode( 'comment_moderation', '<p class="alert moderation">' . __( 'Your comment is awaiting moderation.', TDOMAIN ) . '</p>' );
    ...
    <!-- .comment-content -->
    <?php /* Show reply link only when comments are enable other wise its generate blank "<span>" */
		...
		do_action( 'close_comment' ); // supreme_close_comment ?>
  </div>
  <!-- #comment-## -->
